 ...
 *
 */
public class Validate_Country_currency_Price_Test extends BaseClass {

	@Test(priority = 1, dataProvider = "Subscription", dataProviderClass = DataProviders.class)
	...
	@Test(priority = 2, dataProvider = "Subscription", dataProviderClass = DataProviders.class)
