 ...
 *
 */
public class Validate_Palestine_Country_currency_Price_Test extends BaseClass {

		@Test(priority = 1, dataProvider = "Palestine", dataProviderClass = DataProviders.class)
	public void Get_UAE_Country_currency_Package(String countryName, String Subscription_Type, String ExpectedPrice,
	...
	@Test(priority = 2, dataProvider = "Palestine", dataProviderClass = DataProviders.class)
