 ...
 *
 */
public class Validate_Oman_Country_currency_Price_Test extends BaseClass {

		@Test(priority = 1, dataProvider = "Oman", dataProviderClass = DataProviders.class)
	...
	@Test(priority = 2, dataProvider = "Oman", dataProviderClass = DataProviders.class)
