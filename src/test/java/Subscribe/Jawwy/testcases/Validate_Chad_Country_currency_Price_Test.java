 ...
 *
 */
public class Validate_Chad_Country_currency_Price_Test extends BaseClass {

		@Test(priority = 1, dataProvider = "Chad", dataProviderClass = DataProviders.class)
	...
	@Test(priority = 2, dataProvider = "Chad", dataProviderClass = DataProviders.class)
