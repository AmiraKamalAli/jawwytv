 ...
 *
 */
public class Validate_Djibouti_Country_currency_Price_Test extends BaseClass {

		@Test(priority = 1, dataProvider = "Djibouti", dataProviderClass = DataProviders.class)
	...
	@Test(priority = 2, dataProvider = "Djibouti", dataProviderClass = DataProviders.class)
