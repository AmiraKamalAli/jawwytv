 ...
 *
 */
public class Validate_Jordan_Country_currency_Price_Test extends BaseClass {

		@Test(priority = 1, dataProvider = "Jordan", dataProviderClass = DataProviders.class)
	...
	@Test(priority = 2, dataProvider = "Jordan", dataProviderClass = DataProviders.class)
