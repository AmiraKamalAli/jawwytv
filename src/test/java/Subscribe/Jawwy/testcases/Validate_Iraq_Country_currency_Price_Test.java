 ...
 *
 */
public class Validate_Iraq_Country_currency_Price_Test extends BaseClass {

		@Test(priority = 1, dataProvider = "Iraq", dataProviderClass = DataProviders.class)
	...
	@Test(priority = 2, dataProvider = "Iraq", dataProviderClass = DataProviders.class)
