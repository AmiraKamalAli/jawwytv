 ...
 *
 */
public class Validate_UAE_Country_currency_Price_Test extends BaseClass {

		@Test(priority = 1, dataProvider = "UAE", dataProviderClass = DataProviders.class)
	...
	@Test(priority = 2, dataProvider = "UAE", dataProviderClass = DataProviders.class)
