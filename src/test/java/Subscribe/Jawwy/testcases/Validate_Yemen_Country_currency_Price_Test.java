 ...
 *
 */
public class Validate_Yemen_Country_currency_Price_Test extends BaseClass {

		@Test(priority = 1, dataProvider = "Yemen", dataProviderClass = DataProviders.class)
	...
	@Test(priority = 2, dataProvider = "Yemen", dataProviderClass = DataProviders.class)
